...
print ("V:")
print (V)
[policy,V,nIterations,epsilon] = mdp.modifiedPolicyIteration(np.zeros(mdp.nStates,dtype=int),np.zeros(mdp.nStates),tolerance=0.0,nEvalIterations=np.inf) #policy iteration
print ("----------------------------------------------------------------")
print ("[DEBUG] modifiedPolicyIteration nIterations: {}, epsilon: {}".format(nIterations,epsilon))
print ("policy:")
print (policy)
print ("V:")
print (V)
[policy,V,nIterations,epsilon] = mdp.modifiedPolicyIteration(np.zeros(mdp.nStates,dtype=int),np.zeros(mdp.nStates),tolerance=0.01,nEvalIterations=0) #value iteration
print ("----------------------------------------------------------------")
print ("[DEBUG] modifiedPolicyIteration nIterations: {}, epsilon: {}".format(nIterations,epsilon))
print ("policy:")
print (policy)
print ("V:")
print (V)
[policy,V,nIterations,epsilon] = mdp.modifiedPolicyIteration(np.zeros(mdp.nStates,dtype=int),np.zeros(mdp.nStates),tolerance=0.0,nEvalIterations=0) #value iteration
print ("----------------------------------------------------------------")
print ("[DEBUG] modifiedPolicyIteration nIterations: {}, epsilon: {}".format(nIterations,epsilon))
print ("policy:")
print (policy)
print ("V:")
print (V)
#TODO run the following iteration for 1000 steps and plot
#probably don't need report_full_iter as we don't report full number of iterations in policy iteration,
# but it is good information as the complexity of both steps is different
